 ...
 *  *****************************************************************************
 */
package com.mdx.ryan.pagerecycleview.animator;
...
public class ViewAnimator {
     ...
     */
    private static final int INITIAL_DELAY_MILLIS = 20;
     ...
     */
    public static final int DEFAULT_ANIMATION_DURATION_MILLIS = 500;
     ...
     */
    public void animateViewIfNecessary(final int position, @NonNull final View view, @NonNull final RecyclerView.ViewHolder holder, final Card card, @NonNull final Animator[] animators) {
